  ...
  var translations = {
    pl: {
      ...
      strings: {
        ...
        'bassmarker.lead': 'Narzędzie, które stworzyłem do szybkiego oznaczania uderzeń basu w ścieżce audio — żeby montaż pod muzykę zajmował minuty, nie godziny.',
        'bassmarker.feature1': 'Automatyczne wykrywanie beatów',
        'bassmarker.feature2': 'Eksport znaczników do edytora',
        'bassmarker.feature3': 'Zbudowane dla twórców wideo',
    ...
    en: {
      ...
      strings: {
        ...
        'bassmarker.title': 'BassMarker <span class="gold-text">Pro</span>',
        'bassmarker.lead': "A tool I built to quickly mark bass hits in an audio track — so editing to music takes minutes, not hours.",
        'bassmarker.feature1': 'Automatic beat detection',
        'bassmarker.feature2': 'Marker export to your editor',
        'bassmarker.feature3': 'Built for video creators',
