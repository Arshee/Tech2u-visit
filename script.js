(() => {
  ...
  const businessTranslations = {
    pl: {
      ...
      "contact.label":"KONTAKT", "contact.eyebrow":"WSPÓŁPRACA / PARTNERSTWA", "contact.title":"Masz produkt, projekt albo kampanię? <span>Napisz do mnie.</span>", "contact.body":"Opowiedz, co chcesz pokazać lub zautomatyzować. Odpowiem z konkretną propozycją.", "form.name":"Imię / marka", "form.topic":"Temat", "form.message":"Wiadomość", "form.send":"Wyślij zapytanie ↗"
    },
    en: {
      ...
      "contact.label":"CONTACT", "contact.eyebrow":"COLLABORATION / PARTNERSHIPS", "contact.title":"Have a product, project or campaign? <span>Write to me.</span>", "contact.body":"Tell me what you want to show or automate. I will respond with a concrete proposal.", "form.name":"Name / brand", "form.topic":"Topic", "form.message":"Message", "form.send":"Send request ↗"
    }
  };
